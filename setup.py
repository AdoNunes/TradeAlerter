...
# get the version
version = None
with open(os.path.join('tradealerter', '__init__.py'), 'r') as fid:
...
setup(
    ...
    description='Send trade alerts from order fills.',
    ...
    entry_points = {'console_scripts': ['tradealerter = tradealerter.gui:gui'],
          }
)